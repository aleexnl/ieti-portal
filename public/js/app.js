...
function cancelEdit(textName, textDesc, value, code) {
  if (code) {
    ...
    $(".descInput").replaceWith("<p id='description' value='" + value + "'>" + textDesc + "</p>");
    $(".codeInput").replaceWith("<p id='code' value='" + value + "'>" + code + "</p>");
...
$(function () {
  ...
  $(".editCareer-button").on("click", function (event) {
    var value = $(this).attr("value");
    console.log(value);
    var url = window.location.pathname + "/".concat(value);
    console.log(url);
    var name = $("p[id='name'][value='" + value + "']").text();
    var code = $("p[id='code'][value='" + value + "']").text();
    var description = $("p[id='description'][value='" + value + "']").text();
    $("button[id='editCareer-button'][value='" + value + "']").css("display", "none");
    $("button[id='delete-button'][value='" + value + "']").css("display", "none");
    $("div[value='" + value + "']").append("<button class='primary bg-gray-300 dark:bg-purple-900 dark:text-white my-1 w-full confirm-button' value='" + value + "'>Confirmar</button>");
    $("div[value='" + value + "']").append("<button class='secondary bg-gray-300 dark:bg-purple-200 dark:text-gray-900 my-1 w-full cancel-button' value='" + value + "'>Cancelar</button>");
    $("p[id='name'][value='" + value + "']").replaceWith("<input class='nameInput' value='" + name + "'></input>");
    $("p[id='code'][value='" + value + "']").replaceWith("<input class='codeInput' value='" + code + "'></input>");
    $("p[id='description'][value='" + value + "']").replaceWith("<textarea class='descInput'>" + description + "</textarea>");
    $(".confirm-button").on("click", function (event) {
      event.stopPropagation();
      var data = {
